                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="get">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">วัตถุดิบ</label>
                                    <div class="col-sm-7">
                                        <select name="account" class="form-control rounded">
                                ...
                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">วันที่เบิก</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="input-id-1">จำนวนที่เบิก</label>
                                    <div class="col-sm-7">
