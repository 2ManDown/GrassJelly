                    ...
                    <table class="table table-striped b-t b-light table-bordered">
                        ...
                        <?php foreach ($hub_list as $hub_list) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $hub_list['hub_tel'] ?></td>
                                    ...
                                    $this->db->where('hub_id',$hub_list['hub_id']);
                                        $count_all = $this->db->count_all_results('gj_employee');
                                        echo $count_all;
                                        
                                        ?><a href="<?php echo site_url('hub/hub_employee/').$hub_list['hub_id'] ?>"> <i class="glyphicon glyphicon-eye-open" ></i></td>
