                        ...
                        <tbody>
                            <?php foreach ($product_productbalance as $product_productbalance) { ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><a href="<?php echo site_url('product/product_manufacdetail/') . $product_productbalance['productbalance_id'] ?>"><?php echo $product_productbalance['manufac_produce'] ?></a></td>
