                ...
                <header class="panel-heading font-bold" style="font-size: 23px; color:dimgray;">
                    ...
                    <div class="row wrapper text-right">
                        <div class="col-sm-12 m-b-xs">
                            <a href="<?php echo site_url('user/user_insert') ?>" class="btn btn-s-lg btn-success btn-rounded">เพิ่มข้อมูลผู้ใช้</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped b-t b-light table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($user_data as $user_data) { ?>
                                    ...
                                    <tr>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_id'] ?></a></td>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_username'] ?></a></td>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_name'] ?></a></td>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_email'] ?></a></td>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_tel'] ?></a></td>
                                        <td><a href="<?php //echo site_url('') . $user_data[''] 
                                                        ?>"><?php echo $user_data['user_status'] ?></a></td>
