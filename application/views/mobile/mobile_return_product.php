...
<header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
    <div class="navbar-header aside-md dk">
        ...
        <a href="<?php echo site_url('employee') ?>" class="navbar-brand">
            ...
            <span class="hidden-nav-xs hname">คืนสินค้า</span>
        </a>
...
<section>
    ...
    <?php echo form_open('mobile/mobile_return_insert', 'data-validate="parsley"', 'id="form-valid"') ?>
       ...
       <!--  <div class="form-group pull-in clearfix">
        ...
        <!-- <div class="form-group pull-in clearfix">
            ...
            <div class="col-sm-4">
                ...
                <input type="text" name="countid" class="form-control  input-m" value="<?php //echo $countid?>" placeholder="รหัสการส่งออกสินค้า" readonly required>
            </div>
